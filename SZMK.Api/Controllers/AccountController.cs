...
namespace SZMK.Api.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        {
            List<ApplicationUser> users = await UserManager.Users.ToListAsync<ApplicationUser>();
            ...
            List<UsersInfoViewModel> usersModel = new List<UsersInfoViewModel>();

            foreach (ApplicationUser user in users)
            {
                usersModel.Add(new UsersInfoViewModel
                {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            ApplicationUser user = new ApplicationUser() { UserName = model.UserName, Name = model.Name, MidName = model.MidName, SurName = model.SurName, DateCreate = model.DateCreate, Enable = model.Enable };
